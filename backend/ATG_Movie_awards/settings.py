"""
Django settings for ATG_Movie_awards project.
...
SECRET_KEY = 'django-insecure-f=nlq-q5(5s!5(+fqy3@p10(93)t^--5r+@zlz(q11^z5ynx&q'
...
ROOT_URLCONF = 'ATG_Movie_awards.urls'
...
WSGI_APPLICATION = 'ATG_Movie_awards.wsgi.application'
